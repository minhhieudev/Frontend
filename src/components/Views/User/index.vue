      ...
      <div class="action-user">
        ...
        <div class="d-flex justify-content-start">
            ...
            <div class="d-flex  align-items-center ml-5 border-right">
              ...
              <div class="filter-options pr-4">
                <span v-for="(option, index) in filterOptions" :key="index"
                  :class="{ 'selected': selectedFilter === option.value }" @click="selectFilter(option.value)">
                  {{ option.label }}
                </span>
              </div>
            </div>
          ...
          <div class="d-flex  align-items-center p-2">
            <el-input v-model="search" size="medium" placeholder="Tìm theo tên và email ..." class="custom-input-user">
            </el-input>
            <el-button icon="el-icon-search" class="ml-2" style="background-color: rgb(57, 139, 247);color: white;"
              circle></el-button>
          </div>
        </div>
